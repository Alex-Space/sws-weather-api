...
Получение прогноза погоды для одного города:
`weather -t 1234sdS36f0c3fa005022a2d82ccebc56a -s moscow`
Получение прогноза погоды для нескольких городов:
...
4. После сохранения токена и указания требуемого города, или городов, запускаем утилиту без всяких параметров, просто командой:
